    ...
    if df is not None:
        ...
        if len(filtered_df) > 0:
            ...
            for period in selected_periods:
                ...
                pf = FinancialCalculator.calculate_period_financials(
                    period_data, period
                )
            ...
            with main_col2:
                ...
                # Prepare chart data
                chart_df = FinancialCalculator.prepare_chart_data(
                    period_financials_list
                )
                ...
                selected_metric = st.selectbox(
                    "Select metric to visualize:", metric_options
                )

                # Create and display chart
                fig = ChartGenerator.create_trend_line_chart(
                    chart_df, selected_metric, height=500
                )
