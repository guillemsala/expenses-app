...
def test_aggregate_totals():
    ...
    pf1 = PeriodFinancials(
        ...
        guillem=PersonFinancials(
            salary=6000, bonus=0, total_income=6000,
            shared_expenses=1500, personal_expenses=100,
            total_expenses=1600, net_savings=4400,
            savings_rate=73.33, split_rate=60.0
        ),
        vero=PersonFinancials(
            salary=4000, bonus=0, total_income=4000,
            shared_expenses=1000, personal_expenses=50,
            total_expenses=1050, net_savings=2950,
            savings_rate=73.75, split_rate=40.0
        ),
    ...
    pf2 = PeriodFinancials(
        ...
        guillem=PersonFinancials(
            salary=6000, bonus=1000, total_income=7000,
            shared_expenses=1600, personal_expenses=200,
            total_expenses=1800, net_savings=5200,
            savings_rate=74.29, split_rate=60.0
        ),
        vero=PersonFinancials(
            salary=4000, bonus=500, total_income=4500,
            shared_expenses=1100, personal_expenses=100,
            total_expenses=1200, net_savings=3300,
            savings_rate=73.33, split_rate=40.0
        ),
